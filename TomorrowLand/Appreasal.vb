Public Class Appreasal

    Public TableName As String = "Appreasal"
    ...
    Private Sub DirectBonusCut_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim v() As String = {SubId, "BranchId", "EmpId", "DayDate", "UserName", "MyGetDate", "Reason"}
        bm.Fields = v
        Dim c() As Control = {txtID, Branch, Employee, DayDate, UserName, MyGetDate, Reason}
        bm.control = c
    ...
    Sub FillControls()
        bm.FillControls()
        bm.ApplySecurity(New Button() {btnSave, btnDelete}, False, True, False, False, False, False, False, True, False)
    End Sub
    ...
    Sub ClearControls()
        ...
        bm.ApplySecurity(New Button() {btnSave, btnDelete}, True, True, False, False, False, False, False, True, False)
    End Sub
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtID.KeyDown, Branch.KeyDown, Employee.KeyDown, DayDate.KeyDown
