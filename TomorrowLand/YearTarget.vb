Public Class YearTarget
    ...
    Public TableName As String = "YearTarget"
    Public SubId As String = "Year"
    Public SubName As String = "Value"
    ...
    Sub ClearControls()
        ...
        'txtID.Text = bm.ExecuteScalar("select max(" & SubId & ")+1 from " & TableName)
        '        If txtID.Text = "" Then txtID.Text = "1"
        If txtID.Text <> "" Then txtID.Text = txtID.Text.Trim.PadLeft(Length, "0")
    End Sub
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtName.KeyDown, txtID.KeyDown
        If e.KeyData = Keys.Enter Then
            SelectNextControl(ctl:=sender, forward:=True, nested:=True, tabStopOnly:=True, wrap:=True)
        End If
    End Sub

    Private Sub txtID_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtID.KeyPress, txtName.KeyPress
