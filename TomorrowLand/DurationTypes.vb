Public Class DurationTypes
    Public TableName As String = "DurationTypes"
    Public SubId As String = "Id"
    Public SubName As String = "Name"
    Public SubName2 As String = "NoOfDays"
    ...
    Private Sub DurationTypes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtID.MaxLength = Length
        Dim v() As String = {SubId, SubName, SubName2}
        bm.Fields = v
        Dim c() As Control = {txtID, txtName, NoOfDays}
        bm.control = c
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtName.KeyDown, txtID.KeyDown, NoOfDays.KeyDown
        If e.KeyData = Keys.Enter Then
            SelectNextControl(ctl:=sender, forward:=True, nested:=True, tabStopOnly:=True, wrap:=True)
        End If
    End Sub

    Private Sub txtID_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtID.KeyPress, NoOfDays.KeyPress
