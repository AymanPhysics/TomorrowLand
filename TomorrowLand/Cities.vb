Public Class Cities
    ...
    Private Sub Cities_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtID.MaxLength = Length

        bm.FillCombo(MainTableName, CboMain, "")
        Dim v() As String = {MainId, SubId, SubName, SubName2, "Manager"}
        Dim c() As Control = {CboMain, txtID, txtName, txtName2, CboSub}
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtName.KeyDown, txtID.KeyDown, CboMain.KeyDown, txtName2.KeyDown, CboSub.KeyDown
    ...
    Private Sub txtIDKeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtName2.KeyPress
        If e.KeyChar = "" OrElse Asc(e.KeyChar.ToString.Substring(0)) = 22 OrElse Asc(e.KeyChar.ToString.Substring(0)) = 3 Then
            Return
        End If
        Dim s As New TextBox
