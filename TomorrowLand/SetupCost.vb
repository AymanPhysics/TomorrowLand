Public Class SetupCost
    ...
    Public TableName As String = "SetupCost"
    ...
    Private Sub SetupCost_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        bm.FillCombo("OutcomeReasons", OutcomeReason, "")
        Dim v() As String = {"BranchId", "InvoiceNo", "OutcomeReasonId", "Value", "Notes", "UserName", "MyGetDate", "DayDate"}
        bm.Fields = v

        Dim c() As Control = {Branch, InvoiceNo, OutcomeReason, Value, Notes, UserName, MyGetDate, DayDate}
        bm.control = c
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Branch.KeyDown, InvoiceNo.KeyDown, OutcomeReason.KeyDown, Value.KeyDown, Notes.KeyDown, UserName.KeyDown, DayDate.KeyDown
    ...
    Private Sub btnSetupCost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetupCost.Click
        ...
        'Close()
        'If Navigate Then
        '    bm.ShowForm(P, SetupCost, "SetupCost", Location)
        'End If
    End Sub
