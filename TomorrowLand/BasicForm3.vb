Public Class BasicForm3
    ...
    Public TestSecurity As Boolean = False
    Private Sub BasicForm3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtID.MaxLength = Length

        bm.FillCombo(MainTableName, CboMain, "")
        Dim v() As String = {MainId, MainId2, SubId, SubName}
        bm.Fields = v

        Dim c() As Control = {CboMain, CboMain2, txtID, txtName}
        bm.control = c
    ...
    Sub FillControls()
        bm.FillControls()
        If TestSecurity Then bm.ApplySecurity(New Button() {btnSave, btnDelete}, False, True, False, False, False, False, False, True, False)
    End Sub
    ...
    Sub ClearControls()
        ...
        If TestSecurity Then bm.ApplySecurity(New Button() {btnSave, btnDelete}, True, True, False, False, False, False, False, True, False)
    End Sub
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtName.KeyDown, txtID.KeyDown, CboMain.KeyDown, CboMain2.KeyDown
