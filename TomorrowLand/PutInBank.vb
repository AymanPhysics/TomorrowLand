Public Class PutInBank
    ...
    Private Sub Outcome_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim v() As String = {"BranchId", "InvoiceNo", "Value", "BankInvNo", "Notes", "UserName", "MyGetDate", "DayDate", "NotRealInvoice"}
        bm.Fields = v

        Dim c() As Control = {Branch, InvoiceNo, Value, BankInvNo, Notes, UserName, MyGetDate, DayDate, NotRealInvoice}
        bm.control = c
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Branch.KeyDown, InvoiceNo.KeyDown, Value.KeyDown, BankInvNo.KeyDown, Notes.KeyDown, UserName.KeyDown, DayDate.KeyDown, NotRealInvoice.KeyDown
    ...
    Private Sub btnOutcome_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOutcome.Click
        ...
        Close()
        If Navigate Then
            bm.ShowForm(P, New Outcome, "Outcome", Location)
        End If
    End Sub
    ...
    Private Sub btnPutInBank_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPutInBank.Click
        ...
        'Close()
        'If Navigate Then
        '    bm.ShowForm(P, PutInBank, "PutInBank", Location)
        'End If
    End Sub
