Public Class Inventory
    ...
    Public TableName As String = "Inventory"
    ...
    Private Sub SubIncome_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim v() As String = {"BranchId", "InvoiceNo", "Type", "DepartmentId", "CategoryId", "Items", "Cnt", "Notes", "UserName", "MyGetDate", "DayDate"}
        bm.Fields = v


        Dim c() As Control = {Branch, InvoiceNo, Type, DepartmentId, CategoryId, ItemId, Cnt, Notes, UserName, MyGetDate, DayDate}
        bm.control = c
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Notes.KeyDown, InvoiceNo.KeyDown, Branch.KeyDown, Cnt.KeyDown, Type.KeyDown, DayDate.KeyDown
