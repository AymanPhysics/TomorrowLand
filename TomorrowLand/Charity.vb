Public Class Charity
    ...
    Public TableName As String = "Charity"
    ...
    Private Sub Charity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        InvoiceNo.MaxLength = Length

        bm.FillCombo(MainTableName, Branch, "")
        Dim v() As String = {"BranchId", "InvoiceNo", "Value", "Notes", "UserName", "MyGetDate", "DayDate"}
        bm.Fields = v

        Dim c() As Control = {Branch, InvoiceNo, Value, Notes, UserName, MyGetDate, DayDate}
        bm.control = c
    ...
    Private Sub btnNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Branch.KeyDown, InvoiceNo.KeyDown, Value.KeyDown, Notes.KeyDown, UserName.KeyDown, DayDate.KeyDown
    ...
    Private Sub btnCharity_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCharity.Click
        ...
        'Close()
        'If Navigate Then
        '    bm.ShowForm(P, Charity, "Charity", Location)
        'End If
    End Sub
End Class