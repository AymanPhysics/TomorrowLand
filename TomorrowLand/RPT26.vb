Public Class RPT26
    ...
    Private Sub RPT26_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Flag = 1 Then
            ...
            rpt.Rpt = "GetBalances2.rpt"
            rpt.paraname = New String() {"@Branch", "@Type", "@DepartmentId", "@CategoryId", "@Detail", "@DeficitOnly", "@FromDate", "@ToDate"}
            rpt.paravalue = New String() {Branch.SelectedValue.ToString, Type.SelectedIndex.ToString, DepartmentId.SelectedValue.ToString, CategoryId.SelectedValue.ToString, ItemId.SelectedValue.ToString, IIf(DeficitOnly.Checked, "1", "0"), FromDate.Text, ToDate.Text}
            rpt.ShowDialog()
        End If
    End Sub
